...
| In-turn interjection items | `planned / decision-recorded` | [task-card](260902/1437-in-turn-interjection-items/task-card.md), OpenSpec [add-in-turn-interjection-items](../../openspec/changes/add-in-turn-interjection-items/proposal.md) | 用户裁决同轨：插队为 Turn 内 `userMessage` 条目，五家历史折叠 + 实时条目；未开工 |
