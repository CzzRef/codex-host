...
- Domain glossary: [../../docs/领域术语表.md](../../docs/领域术语表.md)
- Harness command integration: [../../docs/harness-command-integration.md](../../docs/harness-command-integration.md)
- Product docs: [../../docs/](../../docs/)
- OpenSpec: [../../openspec/](../../openspec/)
- Existing task docs: [../../docs/tasks/](../../docs/tasks/)
- DB knowledge: not configured for this project

## Legacy / Historical Sources

- Archived analysis under `docs/archive/` is evidence, not current authority, until promoted.
